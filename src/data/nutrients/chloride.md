...
functions:
  ...
  - Acid-base balance (chloride shift in RBCs)
rda:
  nih:
    - group: Adults 19-50
      amount: 2300 mg (AI)
  ...
  who:
    - group: Adults
      amount: Adequate from normal salt intake
  efsa:
    - group: Adults
...
deficiency:
  ...
  riskGroups:
    - People with prolonged vomiting
    - Cystic fibrosis patients (high sweat chloride)
toxicity:
  symptoms:
...
testing:
  methods:
    - Serum chloride (basic metabolic panel)
    - Sweat chloride test (diagnostic for cystic fibrosis)
  sampleType: Blood (serum)
sources:
  - name: Table salt (1 tsp)
    amount: 3500
    unit: mg
  - name: Seaweed (1 sheet)
    amount: 262
    unit: mg
...
interactions:
  - substance: Diuretics
    effect: Can cause hypochloremia by increasing chloride excretion
history: Chloride has been consumed as part of salt since ancient times. The element chlorine was discovered in 1774 by Carl Wilhelm Scheele. The sweat chloride test for cystic fibrosis was developed in the 1950s after Paul di Sant'Agnese noticed that CF patients had salty sweat during a heat wave.
funFacts:
