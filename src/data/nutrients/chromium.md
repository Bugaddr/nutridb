...
deficiency:
  ...
  riskGroups:
    ...
    - Possibly type 2 diabetics
toxicity:
  symptoms:
    - Kidney damage (at very high doses)
    - Liver damage
    - Note — hexavalent chromium (Cr⁶⁺) is carcinogenic; trivalent (Cr³⁺) is safe
  upperLimit: No established UL for Cr³⁺
  notes: The "Erin Brockovich" chromium was hexavalent Cr(VI) — a completely different form. Dietary Cr(III) is safe.
normalLevels:
  bloodRange: 0.05-0.5 mcg/L (serum)
  unit: mcg/L
testing:
  methods:
...
myths:
  ...
  - myth: All chromium is the same
    reality: Trivalent Cr(III) in food and supplements is safe. Hexavalent Cr(VI) from industrial pollution is carcinogenic.
precautions:
  - Chromium picolinate may interact with diabetes medications — monitor blood sugar
  - Kidney patients should avoid supplementation
interactions:
  - substance: Insulin and diabetes drugs
