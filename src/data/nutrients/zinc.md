...
rda:
  nih:
    ...
    - group: Lactating
      amount: 12 mg
    - group: Vegetarians
      amount: 50% more than listed amounts
  who:
    - group: Adults
...
normalLevels:
  bloodRange: 60-120 mcg/dL (9.2-18.4 µmol/L)
  unit: mcg/dL
  notes: Serum zinc is a poor indicator — drops during infection/inflammation (acute phase response). Plasma zinc is marginally better.
testing:
  methods:
    - Serum/plasma zinc (most common but limited)
    - Hair zinc analysis (controversial)
    - Alkaline phosphatase (zinc-dependent enzyme — low may indicate deficiency)
...
precautions:
  ...
  - Phytates in whole grains and legumes reduce absorption — soak or sprout to reduce
  - Take zinc supplements with food to reduce nausea
interactions:
  - substance: Copper
    effect: Zinc inhibits copper absorption at supplemental doses — always supplement together
  - substance: Iron
    effect: High-dose zinc may inhibit non-heme iron absorption
  - substance: Quinolone antibiotics
